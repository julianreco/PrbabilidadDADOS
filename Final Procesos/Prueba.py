...
btnprobabilidad = Button(window, text="Confirmar", command=clickedprobabilidad, padx=5)
btncaradado = Button(window, text="Confirmar", command=clickedcaradado, padx=5)
btncaradadopar = Button(window, text="Caras Pares", command=juegodadopar, padx=5)
btncaradadoimpar = Button(window, text="Caras Impares", command=juegodadoimpar, padx=5)
btnjugardado = Button(window, text="Cara individual", command=juegodado, padx=5)
